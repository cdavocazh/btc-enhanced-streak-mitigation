...
### Iteration - Auto Evaluation (20260225)

**Generated by:** `eval_regular_exec.sh`
**Timestamp:** 2026-02-25 22:07:59

**What was done:**
1. Ran full walk-forward evaluation
2. Ran strategy learner for trend analysis
3. Created adjustment folder: `strategy_adj_20260225/`
4. Generated 6 parameter adjustment experiments
5. Ran backtests with adjusted parameters
6. Generated HTML report

**Results Location:**
- Experiment folder: `eval/strategy_adj_20260225/`
- HTML Report: `eval/strategy_adj_20260225/experiment_report.html`
- Raw Results: `eval/strategy_adj_20260225/experiment_results.json`


---

### Iteration - Auto Evaluation (20260227)

**Generated by:** `eval_regular_exec.sh`
**Timestamp:** 2026-02-27 20:58:39

**What was done:**
1. Ran full walk-forward evaluation
2. Ran strategy learner for trend analysis
3. Created adjustment folder: `strategy_adj_20260227/`
4. Generated 6 parameter adjustment experiments
5. Ran backtests with adjusted parameters
6. Generated HTML report

**Results Location:**
- Experiment folder: `eval/strategy_adj_20260227/`
- HTML Report: `eval/strategy_adj_20260227/experiment_report.html`
- Raw Results: `eval/strategy_adj_20260227/experiment_results.json`

---

### Agent Framework Enhancement (2026-03-01)

**What was done:**
1. Added antithetic variates to brute-force Monte Carlo validation (~50% variance reduction)
2. Added antithetic variates to stratified Monte Carlo validation (within-strata reversal)
3. Created bootstrap particle filter for regime-adaptive parameter estimation
4. Expanded agent tool count from 8 to 14 (both OAI and LangChain)
5. Updated system prompt with particle filter analysis section
6. Added tool icons for new validation tools

**New Validation Capabilities:**
- `validation/monte_carlo_validation.py --antithetic` — Pairs each shuffle Z with reverse(Z)
- `validation/stratified_monte_carlo.py --antithetic` — Reverses PnL within each stratum
- `validation/particle_filter.py --particles 500` — Bayesian regime parameter estimation

**New Agent Tools (6 added):**
| Tool | Description |
|------|-------------|
| `read_evaluation_history` | Read last N evaluation iterations |
| `run_monte_carlo_validation` | Brute-force MC with antithetic variates |
| `run_stratified_monte_carlo` | Stratified MC with antithetic variates |
| `read_monte_carlo_results` | Read existing MC results |
| `run_particle_filter` | Particle filter for regime parameters |
| `read_particle_filter_results` | Read particle filter posteriors |
